...
$(() => {
    ...
    sltUnidade.select2({
        ajax: {
            url: ROOT + '/Usuario/BuscarUnidadesPorNomeOuSigla',
            dataType: 'json',
            delay: 500,
            data: (params) => {
                return {
...
function vincular() {
    ...
    $.ajax({
        type: 'POST',
        url: ROOT +  '/Usuario/VincularPerfil',
        data: data,
        dataType: 'json',
...
function ajaxTablePerfilUnidade(params) {
    ...
    $.ajax({
        type: 'POST',
        url: ROOT +  '/Usuario/BuscarUnidadesPerfisUsuario',
...
function excluirPerfilUnidade(idUsuarioPerfilUnidade) {
    $.ajax({
        type: 'POST',
        url: ROOT +  '/Usuario/ExcluirVinculo',
