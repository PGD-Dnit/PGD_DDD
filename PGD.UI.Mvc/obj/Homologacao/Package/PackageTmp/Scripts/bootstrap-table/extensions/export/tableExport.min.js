...
(function (c) {
    c.fn.tableExport = function (m) {
        ...
        function P(b) { var d = []; c(b).find("thead").first().find("th").each(function (b, a) { void 0 !== c(a).attr("data-field") ? d[b] = c(a).attr("data-field") : d[b] = b.toString() }); return d } function L(b) {
            ...
            if ("function" === typeof g) {
                var l = !1; "function" === typeof a.onIgnoreRow && (l = a.onIgnoreRow(c(b), e)); if (!1 === l && -1 === c.inArray(e, a.ignoreRow) && -1 === c.inArray(e - k, a.ignoreRow) && L(c(b))) {
                    var t = x(c(b), d), q = 0; t.each(function (b) {
                        var a = c(this), d, l = S(this), k = T(this); c.each(E, function () {
                            if (e >= this.s.r &&
                                e <= this.e.r && q >= this.s.c && q <= this.e.c) for (d = 0; d <= this.e.c - this.s.c; ++d)g(null, e, q++)
                        }); if (!1 === Da(a, t.length, b)) { if (k || l) l = l || 1, E.push({ s: { r: e, c: q }, e: { r: e + (k || 1) - 1, c: q + l - 1 } }); g(this, e, q++) } if (l) for (d = 0; d < l - 1; ++d)g(null, e, q++)
                    }); c.each(E, function () { if (e >= this.s.r && e <= this.e.r && q >= this.s.c && q <= this.e.c) for (Z = 0; Z <= this.e.c - this.s.c; ++Z)g(null, e, q++) })
                }
            }
        } function na(b, a, e, c) {
            if ("undefined" !== typeof c.images && (e = c.images[e], "undefined" !== typeof e)) {
                a = a.getBoundingClientRect(); var d = b.width / b.height, l =
                    a.width / a.height, k = b.width, q = b.height, f = 19.049976 / 25.4, h = 0; l <= d ? (q = Math.min(b.height, a.height), k = a.width * q / a.height) : l > d && (k = Math.min(b.width, a.width), q = a.height * k / a.width); k *= f; q *= f; q < b.height && (h = (b.height - q) / 2); try { c.doc.addImage(e.src, b.textPos.x, b.y + h, k, q) } catch (Ia) { } b.textPos.x += k
            }
        } function oa(b, d) {
            ...
            var d = 0; "undefined" !== typeof e && (d = e.colspan); if (0 <= d) {
                for (var c = b.width, l = b.textPos.x, t = a.table.columns.indexOf(a.column), q = 1; q < d; q++)c += a.table.columns[t + q].width; 1 < d && ("right" === b.styles.halign ? l = b.textPos.x + c - b.width : "center" === b.styles.halign && (l = b.textPos.x + (c - b.width) / 2)); b.width = c; b.textPos.x = l; "undefined" !==
        ...
        "undefined" !== typeof b && null !== b && (b.hasAttribute("data-tableexport-canvas") ? (a = (new Date).getTime(), c(b).attr("data-tableexport-canvas", a), e.images[a] = { url: '[data-tableexport-canvas="' + a + '"]', src: null }) : "undefined" !== a && null !=
            ...
            d.each(function () {
                if (c(this).is("div")) {
                    ...
                    t = this.getBoundingClientRect(), q = this.offsetLeft * e.wScaleFactor, f = this.offsetTop * e.hScaleFactor, h = t.width * e.wScaleFactor; t = t.height * e.hScaleFactor; e.doc.setDrawColor.apply(void 0, g); e.doc.setFillColor.apply(void 0, d); e.doc.setLineWidth(l); e.doc.rect(b.x + q, b.y + f, h, t, l ? "FD" : "F")
            ...
            if ("function" === typeof e.onAutotableText) e.onAutotableText(e.doc, b, d); else {
                var k = b.textPos.x, g = b.textPos.y, l = {
                    ...
                    for (d = d[0]; d.previousSibling;)d = d.previousSibling; for (var t = !1, q = !1; d;) {
                        var f = d.innerText || d.textContent || "", h = f.length && " " === f[0] ? " " : "", m = 1 < f.length && " " === f[f.length - 1] ? " " : ""; !0 !== a.preserve.leadingWS && (f = h + ha(f)); !0 !== a.preserve.trailingWS && (f = ia(f) + m); c(d).is("br") && (k = b.textPos.x, g += e.doc.internal.getFontSize()); c(d).is("b") ? t = !0 : c(d).is("i") && (q = !0); (t || q) && e.doc.setFontType(t && q ? "bolditalic" : t ? "bold" : "italic"); if (h = e.doc.getStringUnitWidth(f) * e.doc.internal.getFontSize()) {
                        "linebreak" ===
                        ...
                        } if (t || q) c(d).is("b") ? t = !1 : c(d).is("i") && (q = !1), e.doc.setFontType(t || q ? t ? "bold" : "italic" : "normal"); d = d.nextSibling
            ...
            var k = ""; if (null !== b) {
                var g = c(b); if (g[0].hasAttribute("data-tableexport-canvas")) var l = ""; else if (g[0].hasAttribute("data-tableexport-value")) l = (l = g.data("tableexport-value")) ? l + "" : ""; else if (l = g.html(), "function" === typeof a.onCellHtmlData) l =
                ...
                else if (l && "" !== l) if ("" !== c(b).data("tableexport-cellformat")) {
                    var m = l.replace(/\n/g, "\u2028").replace(/(<\s*br([^>]*)>)/gi, "\u2060"), n = c("<div/>").html(m).contents(); f = !1; m = ""; c.each(n.text().split("\u2028"), function (b, d) { 0 < b && (m += " "); !0 !== a.preserve.leadingWS && (d = ha(d)); m += !0 !== a.preserve.trailingWS ? ia(d) : d }); c.each(m.split("\u2060"), function (b, d) { 0 < b && (k += "\n"); !0 !== a.preserve.leadingWS && (d = ha(d)); !0 !== a.preserve.trailingWS && (d = ia(d)); k += d.replace(/\u00AD/g, "") }); k = k.replace(/\u00A0/g, " "); if ("json" ===
                        a.type || "excel" === a.type && "xmlss" === a.mso.fileFormat || !1 === a.numbers.output) f = ja(k), !1 !== f && (k = Number(f)); else if (a.numbers.html.decimalMark !== a.numbers.output.decimalMark || a.numbers.html.thousandsSeparator !== a.numbers.output.thousandsSeparator) if (f = ja(k), !1 !== f) {
                            n = ("" + f.substr(0 > f ? 1 : 0)).split("."); 1 === n.length && (n[1] = ""); var p = 3 < n[0].length ? n[0].length % 3 : 0; k = (0 > f ? "-" : "") + (a.numbers.output.thousandsSeparator ? (p ? n[0].substr(0, p) + a.numbers.output.thousandsSeparator : "") + n[0].substr(p).replace(/(\d{3})(?=\d)/g,
        ...
        } function Ha(a) { for (var b = new ArrayBuffer(a.length), e = new Uint8Array(b), c = 0; c !== a.length; ++c)e[c] = a.charCodeAt(c) & 255; return b } function ra(a) { var b = 0, c; if (0 === a.length) return b; var k = 0; for (c = a.length; k < c; k++) { var g = a.charCodeAt(k); b = (b << 5) - b + g; b |= 0 } return b } function J(b, d, c, k, g, l) {
            var e = !0; "function" === typeof a.onBeforeSaveToFile && (e = a.onBeforeSaveToFile(b,
                d, c, k, g), "boolean" !== typeof e && (e = !0)); if (e) try { if (wa = new Blob([b], { type: c + ";charset=" + k }), saveAs(wa, d, !1 === l), "function" === typeof a.onAfterSaveToFile) a.onAfterSaveToFile(b, d) } catch (q) { fa(d, "data:" + c + (k.length ? ";charset=" + k : "") + (g.length ? ";" + g : "") + "," + (l ? "\ufeff" : ""), b) }
        } function fa(b, d, c) {
        ...
        if ("csv" === a.type || "tsv" === a.type || "txt" === a.type) {
            var M = "", W = 0; E = []; n = 0; var ka = function (b, d, e) {
                b.each(function () {
                    p = ""; C(this, d, n, e + b.length, function (b, c, d) {
                        var e = p, g = ""; if (null !== b) if (b = B(b, c, d), c = null === b || "" === b ? "" : b.toString(), "tsv" === a.type) b instanceof Date && b.toLocaleString(), g = ca(c, "\t", " "); else if (b instanceof Date) g = a.csvEnclosure + b.toLocaleString() + a.csvEnclosure; else if (g = ua(c), g = ca(g, a.csvEnclosure, a.csvEnclosure + a.csvEnclosure), 0 <= g.indexOf(a.csvSeparator) || /[\r\n ]/g.test(g)) g = a.csvEnclosure +
                            g + a.csvEnclosure; p = e + (g + ("tsv" === a.type ? "\t" : a.csvSeparator))
            ...
            n = 0; E = []; var A = "INSERT INTO " + a.sql.tableEnclosure + a.tableName + a.sql.tableEnclosure + " ("; r = v(c(w)); c(r).each(function () { C(this, "th,td", n, r.length, function (b, c, e) { A += a.sql.columnEnclosure + B(b, c, e) + a.sql.columnEnclosure + "," }); n++; A = c.trim(A).substring(0, A.length - 1) }); A += ") VALUES "; u = y(c(w)); c(u).each(function () {
                p =
                ""; C(this, "td,th", n, r.length + u.length, function (a, c, e) { p += "'" + B(a, c, e) + "'," }); 3 < p.length && (A += "(" + p, A = c.trim(A).substring(0, A.length - 1), A += "),"); n++
            ...
            var ma = [], z = []; c(w).filter(function () { return L(c(this)) }).each(function () {
                function b(a, b, d) {
                    var e = []; c(a).each(function () {
                        var b = 0, g = 0; p = ""; C(this, "td,th", n, d + a.length, function (a, d, l) {
                            if (null !== a) {
                                ...
                                }); if (a || k) a = a || 1, k = k || 1, e.push({ s: { r: n, c: g }, e: { r: n + a - 1, c: g + k - 1 } }); 1 < k && (f += ' ss:MergeAcross="' + (k - 1) + '"', g += k - 1); 1 < a && (f += ' ss:MergeDown="' + (a - 1) + '" ss:StyleID="rsp1"'); 0 < b && (f += ' ss:Index="' + (g + 1) + '"', b = 0); p += "<Cell" + f + '><Data ss:Type="' + l + '">' + c("<div />").text(d).html() + "</Data></Cell>\r"; g++
                            }
                        }); 0 < p.length && (F += '<Row ss:AutoFitHeight="0">\r' + p + "</Row>\r"); n++
                    }); return a.length
            ...
            m = "excel" === a.type || "xls" === a.type ? "excel" : "word"; D = "excel" === m ? "xls" : "doc"; h = 'xmlns:x="urn:schemas-microsoft-com:office:' + m + '"'; var F = "", X = ""; c(w).filter(function () { return L(c(this)) }).each(function () {
                var b =
                    c(this); "" === X && (X = a.mso.worksheetName || b.find("caption").text() || "Table", X = c.trim(X.replace(/[\\\/[\]*:?'"]/g, "").substring(0, 31))); !1 === a.exportHiddenCells && (G = b.find("tr, th, td").filter(":hidden"), R = 0 < G.length); n = 0; E = []; Q = P(this); F += "<table><thead>"; r = v(b); c(r).each(function () {
                        var b = c(this); p = ""; C(this, "th,td", n, r.length, function (c, d, g) {
                            if (null !== c) {
                                var e = "", f = document.defaultView.getComputedStyle(c, null), k = document.defaultView.getComputedStyle(b[0], null); p += "<th"; for (var h in a.mso.styles) {
                                    var m =
                                        f[a.mso.styles[h]]; "" === m && (m = k[a.mso.styles[h]]); "" !== m && "0px none rgb(0, 0, 0)" !== m && "rgba(0, 0, 0, 0)" !== m && (e += "" === e ? 'style="' : ";", e += a.mso.styles[h] + ":" + m)
                                } "" !== e && (p += " " + e + '"'); e = S(c); 0 < e && (p += ' colspan="' + e + '"'); e = T(c); 0 < e && (p += ' rowspan="' + e + '"'); p += ">" + B(c, d, g) + "</th>"
                            }
                        }); 0 < p.length && (F += "<tr>" + p + "</tr>"); n++
                    }); F += "</thead><tbody>"; u = y(b); c(u).each(function () {
                        var b = c(this); p = ""; C(this, "td,th", n, r.length + u.length, function (d, f, g) {
                            if (null !== d) {
